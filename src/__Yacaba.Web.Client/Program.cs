...
builder.Services.AddHttpClient("Yacaba.Web.ServerAPI")
...
builder.Services.AddScoped(provider =>
{
    ...
    return factory.CreateClient("Yacaba.Web.ServerAPI");
});

builder.Services.AddOidcAuthentication(options =>
{
    options.ProviderOptions.ClientId = "Yacaba.Web-blazor-client";
